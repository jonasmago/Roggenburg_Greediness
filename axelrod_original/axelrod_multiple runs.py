...
class Axelrod():
    ...
    def __init__(self):
        ...
        self.results['greediness'] = [] # empty dictionary
        self.results['performance'] = {} # empty dictionary        
        self.results['performance'] = {i: [] for i in range(SIZE**2)}
    ...
    def run_sim(self):
        ...
        for i in range (SIZE**2):
            self.results['greediness'].append(self.agents[i].greediness)
        print()
        ...
        for i in range (SIZE**2):
            ...
            self.results['performance'][i].append(self.agents[i].performance)
